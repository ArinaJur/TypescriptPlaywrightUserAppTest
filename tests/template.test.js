...
test_1.test.describe('Test Suite Name', () => __awaiter(void 0, void 0, void 0, function* () {
    let apiRequest;
    ...
    (0, test_1.test)('Unique Test Name', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    }));
